...
public class SystemConfig {
    // 小程序相关配置
    public final static String LITEMALL_WX_INDEX_NEW = "mymall_wx_index_new";
    public final static String LITEMALL_WX_INDEX_HOT = "mymall_wx_index_hot";
    public final static String LITEMALL_WX_INDEX_BRAND = "mymall_wx_index_brand";
    public final static String LITEMALL_WX_INDEX_TOPIC = "mymall_wx_index_topic";
    public final static String LITEMALL_WX_INDEX_CATLOG_LIST = "mymall_wx_catlog_list";
    public final static String LITEMALL_WX_INDEX_CATLOG_GOODS = "mymall_wx_catlog_goods";
    public final static String LITEMALL_WX_SHARE = "mymall_wx_share";
    // 运费相关配置
    public final static String LITEMALL_EXPRESS_FREIGHT_VALUE = "mymall_express_freight_value";
    public final static String LITEMALL_EXPRESS_FREIGHT_MIN = "mymall_express_freight_min";
    // 订单相关配置
    public final static String LITEMALL_ORDER_UNPAID = "mymall_order_unpaid";
    public final static String LITEMALL_ORDER_UNCONFIRM = "mymall_order_unconfirm";
    public final static String LITEMALL_ORDER_COMMENT = "mymall_order_comment";
    // 商场相关配置
    public final static String LITEMALL_MALL_NAME = "mymall_mall_name";
    public final static String LITEMALL_MALL_ADDRESS = "mymall_mall_address";
    public final static String LITEMALL_MALL_PHONE = "mymall_mall_phone";
    public final static String LITEMALL_MALL_QQ = "mymall_mall_qq";
    public final static String LITEMALL_MALL_LONGITUDE = "mymall_mall_longitude";
    public final static String LITEMALL_MALL_Latitude = "mymall_mall_latitude";
