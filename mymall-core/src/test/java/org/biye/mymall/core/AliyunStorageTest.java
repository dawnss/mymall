...
import org.biye.mymall.core.storage.AliyunStorage;
...
public class AliyunStorageTest {
    ...
    public void test() throws IOException {
        ...
        aliyunStorage.store(new FileInputStream(test), testFile.length(), "image/png", "mymall.png");
        Resource resource = aliyunStorage.loadAsResource("mymall.png");
        String url = aliyunStorage.generateUrl("mymall.png");
