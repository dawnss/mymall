...
public class AdminUserController {
    ...
    public Object list(String username, String mobile,
        ...
        List<MymallUser> userList = userService.querySelective(username, mobile, page, limit, sort, order);
    ...
    public Object userDetail(@NotNull Integer id) {
    	MymallUser user=userService.findById(id);
        return ResponseUtil.ok(user);
    }
    @RequiresPermissions("admin:user:list")
    @RequiresPermissionsDesc(menu = {"用户管理", "会员管理"}, button = "编辑")
    @PostMapping("/update")
    public Object userUpdate(@RequestBody MymallUser user) {
