...
import org.biye.mymall.db.service.MymallAdService;
...
public class AdminAdController {
    ...
    private Object validate(MymallAd ad) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody MymallAd ad) {
    ...
    public Object read(@NotNull Integer id) {
        MymallAd ad = adService.findById(id);
        return ResponseUtil.ok(ad);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody MymallAd ad) {
        Object error = validate(ad);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody MymallAd ad) {
        Integer id = ad.getId();
        if (id == null) {
            return ResponseUtil.badArgument();
        }
