...
import static org.biye.mymall.admin.util.AdminResponseCode.*;
import static org.biye.mymall.admin.util.AdminResponseCode.ORDER_PAY_FAILED;
...
public class AdminOrderService {
    ...
    public Object detail(Integer id) {
        MymallOrder order = orderService.findById(id);
        List<MymallOrderGoods> orderGoods = orderGoodsService.queryByOid(id);
    ...
    public Object reply(String body) {
        ...
        // 目前只支持回复一次
        MymallComment comment = commentService.findById(commentId);
        if(comment == null){
            return ResponseUtil.badArgument();
        }
