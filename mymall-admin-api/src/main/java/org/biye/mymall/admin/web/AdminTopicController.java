...
public class AdminTopicController {
    ...
    public Object list(String title, String subtitle,
        ...
        List<MymallTopic> topicList = topicService.querySelective(title, subtitle, page, limit, sort, order);
        return ResponseUtil.okList(topicList);
    }

    private Object validate(MymallTopic topic) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody MymallTopic topic) {
    ...
    public Object read(@NotNull Integer id) {
        ...
        List<MymallGoods> goodsList = null;
    ...
    @PostMapping("/update")
    public Object update(@RequestBody MymallTopic topic) {
        Object error = validate(topic);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody MymallTopic topic) {
