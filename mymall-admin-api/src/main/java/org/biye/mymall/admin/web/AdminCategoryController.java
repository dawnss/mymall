...
import org.biye.mymall.admin.vo.CategoryVo;
...
public class AdminCategoryController {
    ...
    public Object list() {
        ...
        List<MymallCategory> categoryList = categoryService.queryByPid(0);
        for (MymallCategory category : categoryList) {
            ...
            List<MymallCategory> subCategoryList = categoryService.queryByPid(category.getId());
            for (MymallCategory subCategory : subCategoryList) {
