...
import org.biye.mymall.db.service.MymallFeedbackService;
...
public class AdminFeedbackController {
    ...
    public Object list(Integer userId, String username,
        ...
        List<MymallFeedback> feedbackList = feedbackService.querySelective(userId, username, page, limit, sort,
                order);
