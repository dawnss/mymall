...
public class AdminBrandController {
    ...
    public Object list(String id, String name,
        ...
        List<MymallBrand> brandList = brandService.querySelective(id, name, page, limit, sort, order);
        return ResponseUtil.okList(brandList);
    }

    private Object validate(MymallBrand brand) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody MymallBrand brand) {
    ...
    public Object read(@NotNull Integer id) {
        MymallBrand brand = brandService.findById(id);
        return ResponseUtil.ok(brand);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody MymallBrand brand) {
        Object error = validate(brand);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody MymallBrand brand) {
