package org.biye.mymall.admin.shiro;
...
import org.biye.mymall.db.service.MymallPermissionService;
import org.biye.mymall.db.service.MymallRoleService;
 ...
 * https://gitee.com/linlinjava/mymall/issues/I3I94X#note_4809495
 */
public class AdminAuthorizingRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        MymallAdmin admin = (MymallAdmin) getAvailablePrincipal(principals);
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        MymallAdmin admin = adminList.get(0);
