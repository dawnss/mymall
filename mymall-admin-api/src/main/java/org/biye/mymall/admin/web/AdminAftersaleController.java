...
public class AdminAftersaleController {
    ...
    @Autowired
    private MymallGoodsProductService goodsProductService;
    @Autowired
    ...
    public Object list(Integer orderId, String aftersaleSn, Short status,
        ...
        List<MymallAftersale> aftersaleList = aftersaleService.querySelective(orderId, aftersaleSn, status, page, limit, sort, order);
    ...
    @PostMapping("/recept")
    public Object recept(@RequestBody MymallAftersale aftersale) {
        Integer id = aftersale.getId();
        MymallAftersale aftersaleOne = aftersaleService.findById(id);
    ...
    public Object batchRecept(@RequestBody String body) {
        ...
        for(Integer id : ids) {
            MymallAftersale aftersale = aftersaleService.findById(id);
            if(aftersale == null){
                continue;
            }
    ...
    @PostMapping("/reject")
    public Object reject(@RequestBody MymallAftersale aftersale) {
        Integer id = aftersale.getId();
        MymallAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
    ...
    @PostMapping("/refund")
    public Object refund(@RequestBody MymallAftersale aftersale) {
        Integer id = aftersale.getId();
        MymallAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
            return ResponseUtil.badArgumentValue();
