...
import org.biye.mymall.db.service.MymallCategoryService;
import org.biye.mymall.wx.service.HomeCacheManager;
...
public class WxCatalogController {
    ...
    public Object getSecondCategory(@NotNull Integer id) {
        // 所有二级分类目录
        List<MymallCategory> currentSubCategory = categoryService.queryByPid(id);
    ...
    public Object index(Integer id) {
        ...
        // 当前一级分类目录
        MymallCategory currentCategory = null;
        if (id != null) {
        ...
        // 当前一级分类目录对应的二级分类目录
        List<MymallCategory> currentSubCategory = null;
    ...
    public Object queryAll() {
        ...
        //所有子分类列表
        Map<Integer, List<MymallCategory>> allList = new HashMap<>();
        List<MymallCategory> sub;
        ...
        // 当前一级分类目录
        MymallCategory currentCategory = l1CatList.get(0);
    ...
    public Object current(@NotNull Integer id) {
        // 当前分类
        MymallCategory currentCategory = categoryService.findById(id);
        if(currentCategory == null){
            return ResponseUtil.badArgumentValue();
        }
        List<MymallCategory> currentSubCategory = categoryService.queryByPid(currentCategory.getId());
