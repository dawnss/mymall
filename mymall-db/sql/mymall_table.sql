...
--
-- Table structure for table `mymall_ad`
--

DROP TABLE IF EXISTS `mymall_ad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_ad` (
...
--
-- Table structure for table `mymall_address`
--

DROP TABLE IF EXISTS `mymall_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_admin`
--

DROP TABLE IF EXISTS `mymall_admin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_admin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_aftersale`
--

DROP TABLE IF EXISTS `mymall_aftersale`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_aftersale` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_brand`
--

DROP TABLE IF EXISTS `mymall_brand`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_brand` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_cart`
--

DROP TABLE IF EXISTS `mymall_cart`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_category`
--

DROP TABLE IF EXISTS `mymall_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_collect`
--

DROP TABLE IF EXISTS `mymall_collect`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_collect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `mymall_comment`
--

DROP TABLE IF EXISTS `mymall_comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_coupon`
--

DROP TABLE IF EXISTS `mymall_coupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_coupon_user`
--

DROP TABLE IF EXISTS `mymall_coupon_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_coupon_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Table structure for table `mymall_feedback`
--

DROP TABLE IF EXISTS `mymall_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_feedback` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `mymall_footprint`
--

DROP TABLE IF EXISTS `mymall_footprint`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_footprint` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `mymall_goods`
--

DROP TABLE IF EXISTS `mymall_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_goods_attribute`
--

DROP TABLE IF EXISTS `mymall_goods_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_goods_attribute` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_goods_product`
--

DROP TABLE IF EXISTS `mymall_goods_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_goods_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品表的商品ID',
...
--
-- Table structure for table `mymall_goods_specification`
--

DROP TABLE IF EXISTS `mymall_goods_specification`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_goods_specification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品表的商品ID',
...
--
-- Table structure for table `mymall_groupon`
--

DROP TABLE IF EXISTS `mymall_groupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_groupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `rules_id` int(11) NOT NULL COMMENT '团购规则ID，关联mymall_groupon_rules表ID字段',
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Table structure for table `mymall_groupon_rules`
--

DROP TABLE IF EXISTS `mymall_groupon_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_groupon_rules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_issue`
--

DROP TABLE IF EXISTS `mymall_issue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_issue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_keyword`
--

DROP TABLE IF EXISTS `mymall_keyword`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_log`
--

DROP TABLE IF EXISTS `mymall_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_notice`
--

DROP TABLE IF EXISTS `mymall_notice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_notice_admin`
--

DROP TABLE IF EXISTS `mymall_notice_admin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_notice_admin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_order`
--

DROP TABLE IF EXISTS `mymall_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_order_goods`
--

DROP TABLE IF EXISTS `mymall_order_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_order_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_permission`
--

DROP TABLE IF EXISTS `mymall_permission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_permission` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_region`
--

DROP TABLE IF EXISTS `mymall_region`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_region` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_role`
--

DROP TABLE IF EXISTS `mymall_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_search_history`
--

DROP TABLE IF EXISTS `mymall_search_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_search_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户表的用户ID',
...
--
-- Table structure for table `mymall_storage`
--

DROP TABLE IF EXISTS `mymall_storage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_storage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_system`
--

DROP TABLE IF EXISTS `mymall_system`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_system` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_topic`
--

DROP TABLE IF EXISTS `mymall_topic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_topic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `mymall_user`
--

DROP TABLE IF EXISTS `mymall_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mymall_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
