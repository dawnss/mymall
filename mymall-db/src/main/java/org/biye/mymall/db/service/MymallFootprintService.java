...
import org.biye.mymall.db.dao.MymallFootprintMapper;
import org.biye.mymall.db.domain.MymallFootprint;
import org.biye.mymall.db.domain.MymallFootprintExample;
...
public class MymallFootprintService {
    ...
    public MymallFootprint findById(Integer userId, Integer id) {
        MymallFootprintExample example = new MymallFootprintExample();
