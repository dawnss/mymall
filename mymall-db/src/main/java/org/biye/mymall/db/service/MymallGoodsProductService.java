...
import org.biye.mymall.db.dao.GoodsProductMapper;
import org.biye.mymall.db.dao.MymallGoodsProductMapper;
...
public class MymallGoodsProductService {
    ...
    public void updateById(MymallGoodsProduct product) {
        product.setUpdateTime(LocalDateTime.now());
        mymallGoodsProductMapper.updateByPrimaryKeySelective(product);
    }
}