...
mymall = Spring Boot后端 + Vue管理员前端 + 微信小程序用户前端 + Vue用户移动端

* [文档](https://linlinjava.gitbook.io/mymall)
* [贡献](https://linlinjava.gitbook.io/mymall/contribute)
* [FAQ](https://linlinjava.gitbook.io/mymall/faq)
* [API](https://linlinjava.gitbook.io/mymall/api)
...
或者浏览器采用手机模式访问以下网址: [http://www.abctxyz.com:8080/vue/index.html#/](http://www.abctxyz.com:8080/vue/index.html#/)
...
1. 浏览器打开，输入以下网址: [http://www.abctxyz.com:8080/#/login](http://www.abctxyz.com:8080/#/login)
...
3. 启动小商场和管理后台的后端服务
    ...
    mvn install
    mvn clean package
    java -Dfile.encoding=UTF-8 -jar mymall-all/target/mymall-all-0.1.0-exec.jar
    ```
...
5. 启动小商城前端
   ...
   > 更详细方案请参考[文档](https://linlinjava.gitbook.io/mymall/project)。
...
当前版本[v1.8.0](https://linlinjava.gitbook.io/mymall/changelog)
...
2. [Taro_Mall](https://github.com/jiechud/taro-mall)
    ...
    项目介绍：Taro_Mall是一款多端开源在线商城应用程序，后台是基于mymall基础上进行开发，前端采用Taro框架编写。
 ...
 * 如果真的需要QQ群里提问，请在提问前先完成以下过程：
    * 请仔细阅读本项目文档，特别是是[**FAQ**](https://linlinjava.gitbook.io/mymall/faq)，查看能否解决；
